...
def lambda_handler(event, context):
    ...
    # Crashes with AttributeError: 'bool' object has no attribute 'lower'
    # when isAdmin is sent as boolean False instead of string "false"
    # is_admin = json.loads(event.get("isAdmin", "false").lower())

    # FIX: cast to str() first before calling .lower()
    # This safely handles both string "false" and boolean False
